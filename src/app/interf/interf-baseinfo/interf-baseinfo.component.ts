...
@Component({
  selector: 'interf-baseinfo',
  templateUrl: 'interf-baseinfo.component.html',
  styleUrls: ['interf-baseinfo.component.css']
})
export class InterfBaseinfoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.editData = Object.assign({},this.interf);
